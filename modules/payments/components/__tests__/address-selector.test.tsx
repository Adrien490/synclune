...
describe("AddressSelector", () => {
	describe("rendering conditions", () => {
		...
		it("returns null when addresses array is empty", () => {
			const { container } = render(
				<AddressSelector addresses={[]} selectedAddressId={null} onSelectAddress={vi.fn()} />,
			);
	...
	describe("fieldset and legend", () => {
		it("renders a fieldset element", () => {
			const addresses = [createAddress({ id: "addr-1" }), createAddress({ id: "addr-2" })];
	...
	describe("radio input attributes", () => {
		...
		it("sets the radio value to the address id", () => {
			const addresses = [createAddress({ id: "addr-abc" }), createAddress({ id: "addr-xyz" })];
