	...
	describe("item rendering", () => {
		it("renders all cart item titles", () => {
			const cart = createCart([
				createCartItem({ sku: { id: "sku-1", size: null, color: null, material: null, images: [], product: { title: "Bague Lune" } } }),
				createCartItem({ id: "item-2", sku: { id: "sku-2", size: null, color: null, material: null, images: [], product: { title: "Collier Etoile" } } }),
			])
