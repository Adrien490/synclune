...
import { SkusFilterBadges } from "../skus-filter-badges";
...
describe("SkusFilterBadges", () => {
	it("renders FilterBadges", () => {
		render(<SkusFilterBadges colors={colors} materials={materials} />);
	...
	it("formatFilter returns stock status label for in_stock", () => {
		render(<SkusFilterBadges colors={[]} materials={[]} />);
