...
vi.mock("@/shared/lib/rate-limit-config", () => ({ ADMIN_PRODUCT_TYPE_LIMITS: { CREATE: "pt-create" } }))
...
describe("createProductType", () => {
	...
	it("should create product type with sanitized data", async () => {
		mockSanitizeText.mockReturnValueOnce("Bague sanitized").mockReturnValueOnce("Type de bijou sanitized")
		mockGenerateSlug.mockResolvedValue("bague")
		await createProductType(undefined, validFormData)
