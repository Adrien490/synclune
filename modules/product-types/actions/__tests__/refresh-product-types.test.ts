...
vi.mock("@/shared/lib/rate-limit-config", () => ({ ADMIN_PRODUCT_TYPE_LIMITS: { REFRESH: "pt-refresh" } }))
...
describe("refreshProductTypes", () => {
	beforeEach(() => {
		...
		mockGetProductTypeInvalidationTags.mockReturnValue(["product-types-list", "product-types-detail"])
