...
import { QUANTITY_BOUNDS_ID } from "./sku-selector-utils";
 ...
 *
 * Seul rescapé de `sku-selector-selectors.tsx` : les trois radiogroups (couleur,
...
export function QuantitySection({
	...
	return (
		<fieldset className="space-y-2" disabled={isPending}>
			<legend className="text-sm font-medium">{SKU_SELECTOR_TEXTS.QUANTITY_LEGEND}</legend>
