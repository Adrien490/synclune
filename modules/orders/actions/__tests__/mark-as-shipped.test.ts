...
vi.mock("@/modules/emails/services/order-emails", () => ({ sendShippingConfirmationEmail: mockSendShippingEmail }))
vi.mock("../../services/order-status-validation.service", () => ({ canMarkAsShipped: mockCanMarkAsShipped }))
...
vi.mock("../../schemas/order.schemas", () => ({
	markAsShippedSchema: {
		safeParse: vi.fn().mockReturnValue({
			success: true,
			data: { id: "test", trackingNumber: "1Z999", trackingUrl: undefined, carrier: undefined, sendEmail: true },
		}),
	},
}))
