...
vi.mock("@/shared/lib/rate-limit-config", () => ({ ADMIN_COLLECTION_LIMITS: { REFRESH: "col-refresh" } }))
...
describe("refreshCollections", () => {
	...
	it("should invalidate all collection cache tags on success", async () => {
		mockSuccess.mockReturnValue({ status: ActionStatus.SUCCESS, message: "Collections rafraîchies" })
