...
vi.mock("@/shared/lib/rate-limit-config", () => ({ ADMIN_PRODUCT_UPDATE_LIMIT: "admin-product-update" }))
...
describe("updateProduct", () => {
	beforeEach(() => {
		...
		mockPrisma.product.update.mockResolvedValue({
			id: VALID_CUID, title: "Bracelet Lune Updated", slug: "bracelet-lune",
			description: "Updated description", status: "PUBLIC", typeId: "type_123", updatedAt: new Date(),
		})
