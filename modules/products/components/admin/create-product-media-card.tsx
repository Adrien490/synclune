...
/**
 * Computes the upload progress percentage (0-100) and phase label for shared <UploadProgress>.
 */
...
/**
 * Patches the UploadThing dropzone <input type="file"> with explicit `accept` MIME
 * so the browser picker filters correctly on desktop and iOS.
 */
...
/**
 * Mobile-only "Take a photo" button that opens the native camera in 1 tap.
 * Falls back to silent no-op on devices without camera (browser handles).
 */
