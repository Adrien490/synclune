...
/*
 * Réglage « création produit » : ces cinq littéraux vivaient dans
 * `create-product-media-card.tsx`, un shim d'un seul consommateur inliné le
 * 2026-08-07. Ils restent groupés ici pour que le test continue d'exercer
