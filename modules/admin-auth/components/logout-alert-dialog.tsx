 ...
 * déclencheur (`children` → `AlertDialogTrigger`), or `ConfirmDialog` est une
 * surface strictement contrôlée sans prop `trigger`. C'est le 4ᵉ invariant de
 * sa frontière.
 */
				...
				>
					<AlertDialogHeader>
						...
						<AlertDialogDescription render={<div className="space-y-3" />}>
							<p>Veux-tu vraiment te déconnecter de l&apos;administration ?</p>
					...
					<AlertDialogFooter>
						...
						>
							...
							{isLoggedOut ? "Déconnectée !" : isPending ? "Déconnexion…" : "Se déconnecter"}
						</AlertDialogAction>
					</AlertDialogFooter>
				</form>
			</AlertDialogContent>
