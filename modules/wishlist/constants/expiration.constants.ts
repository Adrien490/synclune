...
const WISHLIST_GRACE_PERIOD_DAYS = 1;

// Durée totale avant suppression définitive (31 jours = 30 + 1 grace period)
const WISHLIST_TOTAL_LIFETIME_DAYS = WISHLIST_EXPIRATION_DAYS + WISHLIST_GRACE_PERIOD_DAYS;

// Conversions en millisecondes
export const WISHLIST_EXPIRATION_MS = WISHLIST_EXPIRATION_DAYS * 24 * 60 * 60 * 1000;
const WISHLIST_GRACE_PERIOD_MS = WISHLIST_GRACE_PERIOD_DAYS * 24 * 60 * 60 * 1000;
const WISHLIST_TOTAL_LIFETIME_MS = WISHLIST_TOTAL_LIFETIME_DAYS * 24 * 60 * 60 * 1000;
