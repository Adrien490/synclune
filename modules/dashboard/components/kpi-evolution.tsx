...
export interface KpiEvolutionProps {
	...
	evolution: number;
	/** Label explicite de la période de comparaison */
	comparisonLabel?: string;
}

/**
 * Composant d'affichage de l'évolution d'un KPI
 * Affiche une flèche (haut/bas) avec le pourcentage et un label optionnel
 */
