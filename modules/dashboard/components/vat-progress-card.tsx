					...
					<Tooltip>
						<TooltipTrigger
							render={
								<button
									type="button"
									className="focus-ring text-muted-foreground/60 hover:text-muted-foreground -m-3 inline-flex size-11 cursor-help touch-manipulation items-center justify-center rounded-full"
