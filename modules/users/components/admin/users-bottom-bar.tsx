...
import { Filter, Menu, Search, ArrowUpDown, X } from "lucide-react";
import {
	BottomBar,
	ActiveDot,
...
export function UsersBottomBar() {
	...
	const buttonRefs = [filterButtonRef, sortButtonRef, searchButtonRef, menuButtonRef];
	...
	return createPortal(
		<>
			<BottomBar
				as="nav"
				aria-label="Filtres, tri, recherche et menu"
				isHidden={isHidden}
			...
			>
				...
				>
					...
					>
						...
						<Filter className={bottomBarIconClass} aria-hidden="true" />
