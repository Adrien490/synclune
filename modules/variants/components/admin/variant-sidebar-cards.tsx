 ...
 */
export function VariantSidebarCards({
	form,
	colors,
	materials,
	viewTransitionPrefix = "variant-create",
}: VariantSidebarCardsProps) {
	return (
		<div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-start">
			...
			<div className="flex flex-col gap-6">
				<PricingCard
					...
					priceOptional
					priceHint="Vide = la variante hérite du prix du produit"
