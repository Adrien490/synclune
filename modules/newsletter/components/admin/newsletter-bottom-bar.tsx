...
import { Menu, Search, ArrowUpDown, X } from "lucide-react";
import {
	BottomBar,
	ActiveDot,
...
import { SORT_LABELS } from "../../constants/subscriber.constants";

const SORT_OPTIONS_LIST: SortOption[] = Object.entries(SORT_LABELS).map(([value, label]) => ({
	value,
	label,
}));

export function NewsletterBottomBar() {
	const { openDrawer, open, close, isOpen, onOpenChange } = useToolbarDrawer<"sort" | "search">();
	...
	const buttonRefs = [sortButtonRef, searchButtonRef, menuButtonRef];
	...
	return createPortal(
		<>
			<BottomBar
				as="nav"
				aria-label="Tri, recherche et menu"
				isHidden={isHidden}
						...
						<form onSubmit={handleSearchSubmit} className="flex flex-col gap-4">
							<div className="relative">
								...
								<input
									...
									aria-label="Rechercher un abonne"
