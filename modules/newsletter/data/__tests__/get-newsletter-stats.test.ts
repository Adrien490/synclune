...
describe("getNewsletterStats", () => {
	...
	it("should calculate inactiveSubscribers as total minus active", async () => {
		mockPrisma.newsletterSubscriber.count.mockResolvedValueOnce(50).mockResolvedValueOnce(50);
	...
	it("should return inactiveSubscribers of 0 when all subscribers are active", async () => {
		mockPrisma.newsletterSubscriber.count.mockResolvedValueOnce(10).mockResolvedValueOnce(10);
	...
	it("should return inactiveSubscribers equal to total when no active subscribers", async () => {
		mockPrisma.newsletterSubscriber.count.mockResolvedValueOnce(15).mockResolvedValueOnce(0);
	...
	it("should exclude soft-deleted subscribers from both counts", async () => {
		mockPrisma.newsletterSubscriber.count.mockResolvedValueOnce(0).mockResolvedValueOnce(0);
