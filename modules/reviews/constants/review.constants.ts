...
export const REVIEW_ERROR_MESSAGES = {
	...
	RESTORE_FAILED: "Erreur lors de la restauration de l'avis",
	...
	REMINDER_FAILED: "Erreur lors de l'envoi du rappel",
	REMINDER_ALREADY_SENT: "Un rappel a déjà été envoyé pour cette commande",
	REQUEST_NOT_SENT: "La demande d'avis initiale n'a pas encore été envoyée",
	ALL_REVIEWED: "Tous les produits de cette commande ont déjà été évalués",
