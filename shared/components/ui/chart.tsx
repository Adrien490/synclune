...
/**
 * Sanitizes a string for safe use in CSS identifiers/values.
...
function ChartTooltipContent({
	...
	const tooltipLabel = (() => {
		...
		const [item] = payload as Payload<ValueType, NameType>[];
				...
				{payload
					...
					.map((item, index) => {
						...
						const indicatorColor =
							color ??
							(itemPayload?.fill as string | undefined) ??
