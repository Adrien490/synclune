	...
	return (
		<div
			...
			className={cn(
				...
				interactive &&
					"focus-visible:ring-ring cursor-pointer transition-shadow hover:shadow-lg focus-visible:ring-2 focus-visible:ring-offset-2",
				className,
			)}
			{...props}
		/>
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("font-display text-lg leading-none font-normal", className)}
			{...props}
		/>
	);
}
