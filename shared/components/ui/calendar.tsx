...
import { CaretDownIcon, CaretLeftIcon, CaretRightIcon } from "@phosphor-icons/react/ssr";
	...
	return (
		<DayPicker
			...
			formatters={{
				...
				formatWeekdayName: (date) => date.toLocaleString("fr-FR", { weekday: "short" }),
				formatCaption: (date) => date.toLocaleString("fr-FR", { month: "long", year: "numeric" }),
				...formatters,
			}}
			classNames={{
