...
function Textarea({ className, autoGrow = false, ref, ...props }: TextareaProps) {
	...
	return (
		<textarea
			...
			data-slot="textarea"
			className={cn(
				"border-input placeholder:text-muted-foreground can-hover:hover:border-ring/70 focus-ring aria-invalid:ring-destructive/20 aria-invalid:border-destructive flex min-h-30 w-full rounded-xl border bg-transparent px-3 py-2 text-base shadow-xs transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50 sm:min-h-25 md:text-sm",
