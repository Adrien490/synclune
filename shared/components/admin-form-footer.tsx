...
export function AdminFormFooter({
	...
	return (
		<div
			className={cn(
				"bg-background/95 sticky bottom-[calc(var(--bottom-bar-height,56px)+env(safe-area-inset-bottom))] z-10 -mx-[var(--admin-main-x,1.5rem)] px-[var(--admin-main-x,1.5rem)] py-3 backdrop-blur-md motion-safe:transition-[backdrop-filter]",
				"md:static md:m-0 md:bg-transparent md:p-0 md:pb-0 md:backdrop-blur-none",
				className,
			)}
			{...props}
		>
