...
export const MULTI_SELECT_LABELS = {
	...
	ariaMultiSelectHelp:
		"Sélection multiple. Utilisez les flèches pour naviguer, Entrée pour sélectionner, Cmd+A pour tout sélectionner, Échap pour fermer.",
...
export const multiSelectVariants = cva(
	"m-1 motion-safe:transition-colors motion-safe:duration-[var(--duration-slow)] ease-in-out",
	{
		variants: {
			variant: {
