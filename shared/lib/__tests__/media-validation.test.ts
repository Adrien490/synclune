...
describe("isAllowedMediaDomain", () => {
	...
	it("should allow the S3 UploadThing domain", () => {
		expect(isAllowedMediaDomain("https://uploadthing-prod.s3.us-west-2.amazonaws.com/file.jpg")).toBe(true)
	})
	...
	it("should allow cdn.synclune.fr when passed in allowedDomains", () => {
		expect(isAllowedMediaDomain("https://cdn.synclune.fr/image.jpg", ALLOWED_MEDIA_DOMAINS)).toBe(true)
	})
