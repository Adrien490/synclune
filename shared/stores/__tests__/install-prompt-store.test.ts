...
describe("createInstallPromptStore", () => {
	...
	let defaultInitState: InstallPromptStore extends infer T ? { visitCount: number; dismissCount: number; permanentlyDismissed: boolean; bannerVisible: boolean; _hasHydrated: boolean } : never
