...
export const AdminInvoiceFailedEmail = ({
	...
	return (
		<Html>
			<Head />
			<Preview>
				ACTION REQUISE : Echec generation facture - {orderNumber}
			</Preview>
					...
					<Section style={{ marginBottom: "24px" }}>
						<div style={EMAIL_STYLES.section.card}>
							...
							{customerCompanyName && (
								...
								>
									<Text style={EMAIL_STYLES.text.small}>Entreprise</Text>
									<Text
										style={{
											margin: 0,
											fontSize: "14px",
							...
							{customerSiret && (
								...
								>
									<Text style={EMAIL_STYLES.text.small}>SIRET</Text>
									<Text
										style={{
											margin: 0,
											fontFamily: "monospace",
