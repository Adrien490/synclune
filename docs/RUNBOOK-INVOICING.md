...
- `cronJob:reconcile-invoices|reconcile-invoices:ereporting-orphans|alert-stuck-orders|reconcile-refunds|retry-invoice-transmissions|transmit-ereporting-batch`
...
### 7. Transactions e-reporting orphelines (anti-trou périodes — EINV-EREPORT-008)
