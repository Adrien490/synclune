lot # SIMPLIFICATION.md — Propositions d'allégement v1
...
| **Lot 5 — réduit à S4.4, ⏸ en attente**        | **Arbitrage Adrien du 2026-08-03** : wishlist et quick-search **GARDÉES** (surfaces auditées + remédiées les 01 et 03/08, visibles côté boutique) ; vidéo gardée. Ne reste que **S4.4** — retrait de la file d'upload hors-ligne + ETA (855 L, admin-only, zéro impact cliente)                                                                                                                                                                                                                                                                                                | ⏸ Bloqué : les 4 consommateurs du code à retirer sont ouverts par la session concurrente. À exécuter dès son commit |
