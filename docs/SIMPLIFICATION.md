...
| **Lot 5 — ⏸ BLOQUÉ + À ARBITRER**              | Rang 4 : wishlist localStorage, quick-search simple, retrait offline-queue/ETA (vidéo GARDÉE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | ⚠️ 3/3 cibles tenues par une session concurrente (quick-search : 16 fichiers sur 17). **Et les 3 viennent d'être auditées + remédiées les 01 et 03/08** — le rang propose de supprimer ce qui vient d'être poli : à confirmer explicitement. Ordre de sûreté ensuite : S4.4 (admin-only) → S4.1 → S4.2 |
