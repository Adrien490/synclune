...
| **Lot 3 — ⏸ EN ATTENTE**         | S3.1 fusion taxonomies                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ⚠️ Bloqué par une session concurrente qui tient `modules/{products,collections,product-types}` dans le même worktree (244 fichiers non commités au 2026-08-03). À lancer dès que son chantier est commité |
...
| **Lot 5 — ⏸ EN ATTENTE**         | Rang 4 : wishlist localStorage, quick-search simple, retrait offline-queue/ETA upload — la vidéo est GARDÉE (décision Adrien)                                                                                                                                                                                                                                                                                                                                                                                                                                                  | ⚠️ Même blocage : `quick-search-dialog` (15 fichiers), composants d'upload et `app/(shop)` sont ouverts par la session concurrente                                                                        |
