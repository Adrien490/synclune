		...
		<NavbarWrapper>
			...
			>
				<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
					<div className="flex h-16 sm:h-20 group-data-[scrolled=true]:h-12 group-data-[scrolled=true]:sm:h-14 items-center gap-4 transition-all duration-300 ease-out">
						...
						<div className="flex items-center justify-center lg:flex-1">
							...
							<Logo
								href="/"
								size={44}
								className="lg:hidden transition-transform duration-300 ease-out origin-center group-data-[scrolled=true]:scale-[0.9]"
								imageClassName="shadow-md hover:shadow-lg transition-shadow duration-300 ease-out"
								priority
								sizes="44px"
								showText={false}
