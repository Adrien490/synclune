		...
		>
			...
			>
				...
				>
					...
					<path d="M12 7 L12 15 Q12 25 8 30 Q4 35 12 35 Q20 35 16 30 Q12 25 12 15" fill="none" stroke="currentColor" strokeWidth="2" />
			...
			<motion.div
				...
				style={{ y: layer3Y }}
			>
				<Sparkle className="absolute top-[8%] left-[25%] w-4 h-4 text-secondary/40" delay={0} />
				<Sparkle className="absolute top-[25%] right-[30%] w-3 h-3 text-primary/35" delay={1} />
				<Sparkle className="absolute top-[50%] left-[18%] w-5 h-5 text-secondary/30" delay={2} />
				<Sparkle className="absolute top-[70%] right-[25%] w-3 h-3 text-primary/40" delay={0.5} />
				<Sparkle className="absolute bottom-[15%] left-[30%] w-4 h-4 text-[oklch(0.75_0.12_280/0.35)]" delay={1.5} />
			</motion.div>
		</div>
	);
}
