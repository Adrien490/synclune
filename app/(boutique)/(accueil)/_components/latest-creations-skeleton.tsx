...
/**
 * Skeleton de chargement pour LatestCreations
 * Affiche un état de chargement structuré pendant le streaming SSR
 *
 * Reproduit exactement la structure de LatestCreations pour éviter
		...
		>
			<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center">
					<div className="h-12 w-72 mx-auto bg-muted animate-pulse rounded-md shadow-lg" />
				</div>
			</div>
		</section>
	);
