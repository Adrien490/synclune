...
export default function AddressesError({ reset }: ErrorPageProps) {
	return (
		<>
			<PageHeader title="Mes adresses" description="Une erreur est survenue" variant="compact" />
			...
			<Empty className="mt-4 mb-12 sm:my-12">
				...
				<EmptyContent>
					<p className="text-muted-foreground mb-6 max-w-md">
						Une erreur est survenue lors du chargement de vos adresses. Réessayez dans quelques
						instants.
					</p>
