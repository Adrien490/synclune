...
export const metadata: Metadata = {
	...
	keywords: ["mentions légales", "éditeur", "hébergeur", "informations légales", "Synclune"],
	alternates: {
					...
					<div className="prose prose-slate dark:prose-invert max-w-prose space-y-6">
						<section className="space-y-4">
							...
							<p>
								...
								<br />
								<strong>Code APE/NAF :</strong> 47.91B (Vente à distance sur catalogue spécialisé)
								<br />
							...
							<p>
								<strong>Activité :</strong> Artisanat de bijoux fantaisie proposés à la vente en
								ligne
								<br />
								<strong>Inscription :</strong> Inscrite au Répertoire National des Entreprises (RNE)
							</p>
							<p>
								<strong>Email :</strong>{" "}
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">2. Directeur de la publication</h2>
							<p>
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">3. Hébergement</h2>
							<h3 className="text-lg font-medium sm:text-xl">3.1 Site internet</h3>
							<p>
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">4. Propriété intellectuelle</h2>
							<p>
								L'ensemble du contenu du site <strong>{siteUrl.replace(/^https?:\/\//, "")}</strong>{" "}
								(textes, images, photographies, logo, graphismes, design) est la propriété exclusive
								de Synclune ou de ses partenaires, et est protégé par le Code de la Propriété
								Intellectuelle.
							</p>
							<p>
								Toute reproduction, représentation, modification, publication, adaptation de tout ou
								partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est
								interdite, sauf autorisation écrite préalable de Synclune.
							</p>
							<p>
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">5. Données personnelles</h2>
							<p>
								Synclune s'engage à respecter la vie privée de ses utilisateurs et à protéger leurs
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">6. Cookies</h2>
							<p>
								Le site utilise des cookies techniques nécessaires à son fonctionnement (gestion du
								panier, session utilisateur). Ces cookies ne collectent pas de données personnelles
						...
						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">7. Responsabilité</h2>
							<p>
								Synclune s'efforce d'assurer l'exactitude et la mise à jour des informations
								diffusées sur ce site, dont elle se réserve le droit de corriger, à tout moment et
								sans préavis, le contenu.
							</p>
							<p>
								Toutefois, Synclune ne peut garantir l'exactitude, la précision ou l'exhaustivité
								des informations mises à disposition sur ce site.
							</p>
							<p>
								En conséquence, Synclune décline toute responsabilité pour toute imprécision,
								inexactitude ou omission portant sur des informations disponibles sur le site.
							</p>
						</section>

						<section className="space-y-4">
							<h2 className="text-xl font-semibold sm:text-2xl">8. Liens hypertextes</h2>
							<p>
								Le site peut contenir des liens hypertextes vers d'autres sites. Synclune n'exerce
