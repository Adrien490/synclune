...
const LISTS = [
	...
	{
		page: "app/admin/(protected)/catalogue/couleurs/page.tsx",
		bottomBar: "modules/taxonomies/components/taxonomy-bottom-bar.tsx",
		sheet: "TaxonomyFilterSheet",
	},
	{
		page: "app/admin/(protected)/catalogue/materiaux/page.tsx",
		bottomBar: "modules/taxonomies/components/taxonomy-bottom-bar.tsx",
		sheet: "TaxonomyFilterSheet",
	},
	{
		page: "app/admin/(protected)/catalogue/types-de-produits/page.tsx",
		bottomBar: "modules/taxonomies/components/taxonomy-bottom-bar.tsx",
		sheet: "TaxonomyFilterSheet",
	},
] as const;
