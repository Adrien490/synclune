...
const LIST_PAGES = [
	"app/admin/(protected)/catalogue/produits/page.tsx",
	"app/admin/(protected)/catalogue/produits/[slug]/variantes/page.tsx",
	"app/admin/(protected)/catalogue/collections/page.tsx",
	"app/admin/(protected)/catalogue/couleurs/page.tsx",
	"app/admin/(protected)/catalogue/materiaux/page.tsx",
	"app/admin/(protected)/catalogue/types-de-produits/page.tsx",
	"app/admin/(protected)/ventes/commandes/page.tsx",
	"app/admin/(protected)/ventes/remboursements/page.tsx",
];
