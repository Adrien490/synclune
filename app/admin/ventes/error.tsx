...
export default function VentesError({ error, reset }: ErrorPageProps) {
	return (
		<div
		...
		>
			<div className="max-w-lg w-full rounded-xl border bg-card p-8 text-center shadow-sm">
				...
				<h2 className="text-xl sm:text-2xl font-semibold">Erreur ventes</h2>
				<p className="mt-3 text-muted-foreground">
					Impossible de charger les commandes ou remboursements. Veuillez réessayer.
				</p>
